...
function App() {
  ...
  async function adicionar(e) {
    ...
    if (texto !== '') {
      // Verifica se já existe uma conferência para a loja selecionada
      const q = query(collection(db, 'conferencias'), where('loja', '==', loja))
      ...
      await addDoc(collection(db, 'conferencias'), {
        ...
        .then(() => {
          ...
          document.getElementById('loja').value = 'MS FILINTO'
          setLoja('MS FILINTO')
